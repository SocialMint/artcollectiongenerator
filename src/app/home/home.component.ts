...
export class HomeComponent implements OnInit {
  ...
  nftDescription: FormControl = new FormControl('{name} - Generated by Social Mint NFT Art Generator.', [])
  ...
  createMetadataFile(selectedNftFolderItems: NftItem[], fileName: string){
      ...
      case 'BNB-Chain': {
        metadata =  {
          ...
          collection: {
            ...
            family: "Social Mint NFT Art Generator",
          },
          properties: {
            hash: this.getNFTImageItemsHash(selectedNftFolderItems)
          }
    ...
    if(this.blockChain.value !== 'polygon'){
